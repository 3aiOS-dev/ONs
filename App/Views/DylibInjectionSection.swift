        ...
        GlassSection("Dylib injection") {
            ...
            if dylibURL != nil {
                ...
                HStack(alignment: .top, spacing: 10) {
                    ...
                    Text("iStore copies the dylib into a disposable IPA, adds its load command, then sends that IPA through the existing signer. Your original IPA is unchanged.")
                        .font(T.mono(10))
